<article class="post-127868 post type-post status-publish format-standard hentry
...
As mentioned, you can listen to events in the capture phase by setting the
